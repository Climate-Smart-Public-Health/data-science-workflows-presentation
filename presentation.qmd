...
> [FASRC is a high performance computing resource whose professional responsibility is to save you (and your data) from yourself ^[https://www.rc.fas.harvard.edu/cluster/publications/]]{.yellow style="background: rgba(0, 0, 0, 0.7)"}
...
- (Knuth, 1984 ^[https://www.cs.tufts.edu/~nr/cs257/archive/literate-programming/01-knuth-lp.pdf]) Literate programming is the use of intertwined written language to self-document and explain code.
...
- In data science, we use notebook tools like **Quarto, RMarkdown, or JuPyter** to combine:
  - Narrative
  - Code
  - Outputs
