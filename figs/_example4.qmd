...
dir.create(here("Downloads"), showWarnings = FALSE)

# Download the dataset from and save it into Downloads/
url <- "https://grodri.github.io/datasets/salary.dat"
download.file(url, destfile = here("Downloads/salary.dat"), mode = "wb")

salary_data <- read.table(here("Downloads/salary.dat"), header=TRUE, stringsAsFactors = TRUE)
```
